...
import 'package:flutter_movie_app/bloc/get_movies_bloc.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(strings.trending_persons_on_this_week, style: TextStyle(
                      ...
                      child: Container(
                          ...
                          decoration: new BoxDecoration(
                            ...
                            image: new DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage(strings.person_image_baseUrl + persons[index].profileImg)),
                          )),
                    ),
                    SizedBox(
                      height: 10.0,
