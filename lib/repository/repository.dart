...
class MovieRepository {
  ...
  final Dio _dio = Dio();
  var getPopularUrl = strings.mainUrl+'/movie/top_rated';
  var getMoviesUrl = strings.mainUrl+'/discover/movie';
  var getPlayingUrl = strings.mainUrl+'/movie/now_playing';
  var getGenresUrl = strings.mainUrl+'/genre/movie/list';
  var getPersonsUrl = strings.mainUrl+'/trending/person/week';
  var movieUrl = "$strings.mainUrl/movie";
  ...
  Future<MovieResponse> getPlayingMovies() async {
    var params = {"api_key": strings.apiKey, "language": "en-US", "page": 1};
    try {
      Response response =
  ...
  Future<GenreResponse> getGenres() async {
    var params = {"api_key": strings.apiKey, "language": "en-US"};
    try {
  ...
  Future<PersonResponse> getPersons() async {
    var params = {"api_key": strings.apiKey};
    try {
  ...
  Future<MovieResponse> getMovieByGenre(int id) async {
    var params = {"api_key": strings.apiKey, "language": "en-US", "page": 1, "with_genres": id};
    try {
